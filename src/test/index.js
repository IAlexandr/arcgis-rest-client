...
var featureServerUrl = 'http://gisweb.gcheb.cap.ru/arcgis/rest/services/cheb/oks_soc/FeatureServer/0'; //'https://chebtelekom.ru/arcgis/rest/services/test/test_ai/FeatureServer/0';
var featureServer = new _index2.default.FeatureServer({ featureServerUrl: featureServerUrl });
test(featureServer);